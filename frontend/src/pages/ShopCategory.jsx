...
const ShopCategory = (props) => {
  ...
  return (
    ...
    <Navbar/>
    <Categories/>
    <div className="banner flex flex-col md:flex-row bg-blue-100">
      <div className="md:w-1/4 p-4 bg-gray-300">
        ...
        {/* <div className="mb-4">
          <label className="block mb-1 font-medium">Filter by Color</label>
          <select
            name="color"
            value={filters.color}
            onChange={handleFilterChange}
